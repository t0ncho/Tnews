...
<div id="galleryBG" style="top:1200px">
<div id="galleryTitle">
...
<div id="gallery" style="top:1300px">
<div class="container">
    <div id="slides">
...
// тук трябва да напишеш своята заявка
	$query = "SELECT cat_id,name,date,text,img,id FROM news WHERE cat_id=2 ORDER BY ID DESC LIMIT $offset, $rowsPerPage";
					...
					<td colspan="3" align="center" valign="middle" >
						...
						for($y=0;$y<$num;$y+=$rowsPerPage)
						{
							...
							if(($y > ($start - $eitherside)) && ($y < ($start + $eitherside)))
							{
								if ($y <> $start) {
									?>
									&nbsp;<a id="number" class=" <?php print($class);?>" href="<?php print("bussiness.php?module=guestbook/guestbook_read&page=".(($y/$rowsPerPage)+1) ); ?>"><?php print($pg);?></a>&nbsp;
									<?php
								} else {
									?>
