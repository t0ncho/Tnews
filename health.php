...
$query = "SELECT cat_id,name,date,text,img,id FROM news WHERE cat_id=5 ORDER BY ID DESC LIMIT $offset, $rowsPerPage";	
...
$result  = mysql_query("SELECT COUNT(cat_id) AS numrows FROM news WHERE cat_id=5 ") or die('Error, query failed');
